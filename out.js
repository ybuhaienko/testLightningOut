...
if (!window.$Lightning) {
	$Lightning = (function() {
		...
		function getDelegateScriptUrl() {
			...
			var url = "https://awesome-cloudy-267606-dev-ed.lightning.force.com/lightning/lightning.out.delegate.js?v=" + getDelegateScriptVersion();
